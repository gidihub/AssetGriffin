  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-border bg-card p-10 text-center">
        ...
        <h2 className="text-lg text-foreground">Thanks — we got it</h2>
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 rounded-2xl border border-border bg-card p-6 md:p-8">
      <div className="grid gap-4 md:grid-cols-2">
        <label className="flex flex-col gap-1.5">
          <span className="font-mono text-xs uppercase tracking-[0.08em] text-muted-foreground">Name</span>
          <input
            required
            type="text"
        ...
        <label className="flex flex-col gap-1.5">
          <span className="font-mono text-xs uppercase tracking-[0.08em] text-muted-foreground">Work email</span>
          <input
            required
            type="email"
            className="rounded-lg border border-border bg-background px-3 py-2.5 text-sm text-foreground outline-none focus:border-primary"
      ...
      <label className="flex flex-col gap-1.5">
        <span className="font-mono text-xs uppercase tracking-[0.08em] text-muted-foreground">Company</span>
        <input
          type="text"
          className="rounded-lg border border-border bg-background px-3 py-2.5 text-sm text-foreground outline-none focus:border-primary"
        />
      ...
      <label className="flex flex-col gap-1.5">
        <span className="font-mono text-xs uppercase tracking-[0.08em] text-muted-foreground">How can we help?</span>
        <textarea
          required
          rows={4}
      ...
      <Button type="submit" size="lg" className="h-11 rounded-lg text-sm font-medium">
        Send message
      </Button>
    </form>
  )
